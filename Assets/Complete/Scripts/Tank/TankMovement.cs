...
namespace Complete
{
	...
	//			transform.Translate(new Vector3(Input.GetAxis ("Vertical") * 3 * Time.deltaTime,0,Input.GetAxis ("Horizontal") * 3 * Time.deltaTime));
		...
		public void enemyTankMove(Vector3 pos)
		{
		...
		public void enemyTankRotato(float y)
		{
			...
			Quaternion turnRotation = Quaternion.Euler(new Vector3(0f, y, 0f));

            // Apply this rotation to the rigidbody's rotation.
//			transform.localRotation = Quaternion.Euler(new Vector3(0f, y, 0f));
